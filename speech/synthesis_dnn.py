...
import scipy
import argparse
from train_dnn import dnn_model
...
parser.add_argument('--hidden_layers', default=[2048, 2048, 2048, 2048, 4096])
...
parser.add_argument('--load_model_path', default='exp//dnn_models//model_5.hdf5', help='The path to the saved model')
...
if __name__ == "__main__":
    ...
    model = dnn_model(args.hidden_layers, args.input_tensor, args.output_dim).to(device)
