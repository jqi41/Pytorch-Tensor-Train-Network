...
from train_tucker_cnn import tucker_cnn_model
...
parser.add_argument('--load_model_path', default='exp//tucker_cnn_models//model_9.hdf5', help='The path to the saved model')
...
if __name__ == "__main__":
    ...
    model = tucker_cnn_model(args.n_chans, args.hidden_layer, args.output_dim).to(device)
    ...
    with open(args.noise_list_fn, 'r') as f:
        for line in f:
            ...
            wav.write(os.path.join("enhanced_tucker_cnn", filename), args.sample_rate, np.int16(output*32767))
