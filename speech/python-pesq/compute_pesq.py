...
#ref_dir = "../../data_simu/2spk_2s_data_new_testset_only_center112_norepeat/test" #should have "mix", "spk1", "spk2"
ref_dir="../../data_simu/2spk_2s_crop112_more3_4parts_npylip/test"
#ref_list = [line.rstrip("\n") for line in open("/data2/wujian/WSJ0/ailab_6ch_wsj0/tt/tt.list")]
enh_dir_spk1="../enh_spk1"
enh_dir_spk2="../enh_spk2"
...
for i in range(len(ref_list)):
    ...
    est_i_1,sr = sf.read(enh_dir_spk1+ "/" + fname)
    est_i_2,sr = sf.read(enh_dir_spk2+ "/" + fname)  
